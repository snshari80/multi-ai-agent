...
def build_graph():
    ...
    logger.info(f"guardrail_input_node: {guardrail_input_node}")
    logger.info(f"orchestrator_node: {orchestrator_node}")
    logger.info(f"knowledge_agent_node: {knowledge_agent_node}")
    logger.info(f"sql_agent_node: {sql_agent_node}")
    logger.info(f"research_agent_node: {research_agent_node}")
    logger.info(f"author_agent_node: {author_agent_node}")
    logger.info(f"evaluator_node: {evaluator_node}")
